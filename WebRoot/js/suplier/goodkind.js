...
function gridinit() {
    ...
    jQuery(grid_selector).jqGrid({
        ...
        //subgrid options
        url:base_path+"suplier/getGoodskindList",
        datatype: "json",
        type : "post",
        ...
        colModel:[
            ...
            {name:'list',index:'list',width:90, editable: true
                ,editrules: {
    ...
    $("#updata").click(function() {
        ...
        if (gr != null)
            jQuery(grid_selector).jqGrid('editGridRow', gr, {
                url : base_path+"suplier/suplier/goodskindedit",
    ...
    $("#adddata").click(function() {
        jQuery(grid_selector).jqGrid('editGridRow', "new", {
            url : base_path+"suplier/suplier/goodskindadd",
            afterComplete : function (response, postdata, formid) {
                var res = JSON.parse(response.responseText);
                layer.msg(JSON.parse(response.responseText).msg,{icon:res.status==1?1:2});
                $(".ui-jqdialog-titlebar-close").click();
    ...
    $("#dedata").click(function() {
        ...
        if (gr != null)
            jQuery(grid_selector).jqGrid('delGridRow', gr, {
                url : base_path+"suplier/suplier/goodskinddel",
