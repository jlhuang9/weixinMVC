...
import com.lianchuang.entity.pojo.*;
...
import com.lianchuang.entity.message.resp.Music;
...
public class AdvancedUtil {
	...
	public static UserInfo getUserInfo(String accessToken, String openId) {
		...
		if (null != jsonObject) {
			try {
				...
				// 用户头像
				weixinUserInfo.setTagid_list(jsonObject.getString("headimgurl"));
			} catch (Exception e) {
	 ...
	 *
	 * @param accessToken 接口访问凭证
	 * @param openIdlist 用户列标识
	 * @return WeixinUserInfo
	 */
	public static Object getUserInfo(String accessToken, HashMap<String,String> openIdlist) {
		JSONObject js = new JSONObject();
		JSONArray ja = new JSONArray();
		js.put("user_list",JSONArray.fromObject(openIdlist));
		// 拼接请求地址
		System.out.println(js);
		String requestUrl = "https://api.weixin.qq.com/cgi-bin/user/info/batchget?access_token=ACCESS_TOKEN";
		requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
		// 获取用户信息
		JSONObject jsonObject = CommonUtil.httpsRequest(requestUrl, "POST", js.toString());
		return jsonObject;
	}
	...
	private static final String APP_ID = "54e97cf4081738aacd"; // 这里换成你的app_id
	private static final String APP_SECRET = "cb712958af70c689f703592aac37848e"; 
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = WeixinUtil.gettoken();

		System.out.println(accessToken);
		HashMap<String,String> openIdlist =new HashMap<>();
		openIdlist.put("openid","o3zPIswCazKj2Kgbig8gIWRx6xVE");
		openIdlist.put("openid","o3zPIszwffjm1bbQ2zeb7HA46Bi8");
		openIdlist.put("openid","o3zPIs6pW778v_M6Ift75OrDifKM");

		System.out.println(getUserInfo(accessToken,openIdlist));
...
//		WeixinQRCode weixinQRCode = createTemporaryQRCode(accessToken, 900, 111111);
		 ...
		 */
//		// 组装文本客服消息
//		String jsonTextMsg = makeTextCustomMessage("ocqOljtG6E0kK2Xg16nwFslVMTSQ", "点击查看<a href=\"http://blog.csdn.net/lyq8479\">柳峰的博客</a>");
//		// 发送客服消息
